...
#     experiment_name = "dropout{}_lr{}_wd{}_lambda_u_max{}_xi{}_eps{}_unlabeledloss_warmup_iterations{}_lr_warmup_img{}_em{}".format(args.dropout_rate, args.lr, args.wd, args.lambda_u_max, args.xi, args.eps, args.unlabeledloss_warmup_iterations, args.lr_warmup_img, args.em)
    ...
    experiment_name = "Optimizer-{}_LrSchedule-{}_LrCycleLength-{}_UnlabeledlossWarmupSchedule-{}_UnlabeledlossWarmupIteations-{}_LambdaUMax-{}_GradientAlignStartIterations-{}_lr-{}_wd-{}_xi-{}_eps-{}_em-{}".format(args.optimizer_type, args.lr_schedule_type, args.lr_cycle_length, args.unlabeledloss_warmup_schedule_type, args.unlabeledloss_warmup_iterations, args.lambda_u_max, args.gradient_align_start_iterations, args.lr, args.wd,  args.xi, args.eps, args.em)
    ...
    brief_summary['algorithm'] = 'VAT_GradientOnly'
