...
parser.add_argument('--temperature_MM', default=0.95, type=float, help='temperature for label guessing')
...
#     experiment_name = "dropout{}_lr{}_wd{}_lambda_u_max{}_temperature{}_mu{}_threshold{}_unlabeledloss_warmup_iterations{}_lr_warmup_img{}_em{}".format(args.dropout_rate, args.lr, args.wd, args.lambda_u_max, args.temperature, args.mu, args.threshold, args.unlabeledloss_warmup_iterations, args.lr_warmup_img, args.em)
    ...
    experiment_name = "Optimizer-{}_LrSchedule-{}_LrCycleLength-{}_UnlabeledlossWarmupSchedule-NO_UnlabeledlossWarmupIteations-{}_LambdaUMax-{}_MMTemperature-{}_MMAlpha-{}_lr-{}_wd-{}_temperature-{}_mu-{}_threshold-{}_em-{}".format(args.optimizer_type, args.lr_schedule_type, args.lr_cycle_length, args.unlabeledloss_warmup_iterations, args.lambda_u_max, args.temperature_MM, args.alpha, args.lr, args.wd, args.temperature, args.mu, args.threshold, args.em)
    ...
    brief_summary['algorithm'] = 'FM_AugmentOnly'
