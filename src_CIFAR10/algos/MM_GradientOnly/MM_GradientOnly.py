...
if __name__ == '__main__':
    ...
    experiment_name = "Optimizer-{}_LrSchedule-{}_LrCycleLength-{}_UnlabeledlossWarmupSchedule-{}_UnlabeledlossWarmupIteations-{}_LambdaUMax-{}_GradientAlignStartIterations-{}_lr-{}_wd-{}_temperature-{}_alpha-{}_em-{}".format(args.optimizer_type, args.lr_schedule_type, args.lr_cycle_length, args.unlabeledloss_warmup_schedule_type, args.unlabeledloss_warmup_iterations, args.lambda_u_max, args.gradient_align_start_iterations, args.lr, args.wd,  args.temperature, args.alpha, args.em)
    ...
    brief_summary['algorithm'] = 'MM_GradientOnly'
