...
#experiment setting
parser.add_argument('--dataset_name', default='echo', type=str, choices=['echo'], help='dataset name')
...
#                 transforms.Normalize(mean=mean, std=std),
    ...
    u_train_dataset = dataset(args.u_train_dataset_path, transform_fn=TransformFixMatch())
...
# }
    ...
    for epoch in range(args.start_epoch, args.train_epoch):
        ...
        train_total_loss_list, train_labeled_loss_list, train_unlabeled_loss_unscaled_list, train_unlabeled_loss_scaled_list, train_gradient_dot_sign_list = train_one_epoch(args, weights, l_loader, u_loader, model, ema_model, optimizer, scheduler, epoch)
