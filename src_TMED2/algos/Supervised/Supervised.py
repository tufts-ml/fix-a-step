...
if __name__ == '__main__':
    ...
    experiment_name = "Optimizer-{}_LrSchedule-{}_LrCycleLength-{}_Lr-{}_Wd-{}_Dropout-{}_class_weights-{}".format(args.optimizer_type, args.lr_schedule_type, args.lr_cycle_length, args.lr, args.wd, args.dropout_rate, args.class_weights)
