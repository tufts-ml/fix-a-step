...
#         print("F.cross_entropy(outputs, l_labels, weights, reduction='mean'): {}".format(F.cross_entropy(outputs, l_labels, weights, reduction='mean')))
#         print("F.cross_entropy(outputs, l_labels, weights, reduction='none'): {}".format(F.cross_entropy(outputs, l_labels, weights, reduction='none')))
#         print("F.cross_entropy(outputs, l_labels, weights, reduction='none').mean(): {}".format(F.cross_entropy(outputs, l_labels, weights, reduction='none').mean()))

#         labeledtrain_loss = F.cross_entropy(outputs, l_labels, weights, reduction='none').mean()
