...
#     experiment_name = "lr{}_dropout_rate{}_wd{}_warmup_img{}_lambda_u{}_mu{}_T{}_threshold{}_batch{}_class_weights{}".format(args.lr, args.dropout_rate, args.wd, args.warmup_img, args.lambda_u, args.mu, args.T, args.threshold, args.batch, args.class_weights)
    
    experiment_name = "Optimizer-{}_LrSchedule-{}_LrCycleLength-{}_UnlabeledlossWarmupSchedule-NO_UnlabeledlossWarmupIteations-{}_LambdaUMax-{}_lr-{}_wd-{}_temperature-{}_mu-{}_threshold-{}_class_weights-{}".format(args.optimizer_type, args.lr_schedule_type, args.lr_cycle_length, args.unlabeledloss_warmup_iterations, args.lambda_u_max, args.lr, args.wd,  args.temperature, args.mu, args.threshold, args.class_weights)
