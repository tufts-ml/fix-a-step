...
export experiment='TMED2' #对标'OliverContamination_ssl'
...
export dataset_name='echo' #对标'cifar10'
export data_seed=2
export training_seed=0
export development_size='DEV56' #对标nlabels
...
export unlabeledloss_warmup_iterations='34000' 
