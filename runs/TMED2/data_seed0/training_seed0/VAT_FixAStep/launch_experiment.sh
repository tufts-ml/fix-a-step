...
export implementation='VAT_FixAStep'
...
export train_dir="$ROOT_PATH/experiments/$experiment/$normalization/data_seed$data_seed/training_seed$training_seed/$development_size/$implementation/candidate_param1"
mkdir -p $train_dir
...
export unlabeledloss_warmup_iterations=17000 
