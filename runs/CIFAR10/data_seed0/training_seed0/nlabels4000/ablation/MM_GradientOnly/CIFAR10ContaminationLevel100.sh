...
export implementation='MM_GradientOnly'
...
export nlabels=4000
export CIFAR10ContaminationLevel=100
...
# export train_epoch=27962 #27962 equal to train for 1<<16 kimg in MixMatch and FixMatch repo #10416 equal to train for 500,000 iterations in Oliver et al 2018
