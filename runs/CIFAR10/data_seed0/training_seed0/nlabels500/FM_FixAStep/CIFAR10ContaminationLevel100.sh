...
export implementation='FM_FixAStep'
...
export train_epoch=123333 #223696 equal to train for 1<<16<<10 img in MixMatch and FixMatch repo #83333 equal to train for 500,000 iterations in Oliver et al 2018
