...
export nlabels=500
export CIFAR10ContaminationLevel=75

export train_dir="$ROOT_PATH/experiments/$experiment/$normalization/data_seed$data_seed/training_seed$training_seed/nlabels$nlabels/$implementation/CIFAR10ContaminationLevel$CIFAR10ContaminationLevel/oracle"
mkdir -p $train_dir
...
export u_train_dataset_path="$ROOT_PATH/ML_DATA/$experiment/$normalization/$dataset_name/data_seed$data_seed/nlabels$nlabels/CIFAR10ContaminationLevel$CIFAR10ContaminationLevel/u_train_oracle.npy"
...
export lr_schedule_type='FixedLR'
export lr_cycle_length='NA'
export unlabeledloss_warmup_schedule_type='YU1utRepo_Exact'
